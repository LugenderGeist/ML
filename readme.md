...
<img src="https://github.com/LugenderGeist/MLsupport_files\full_correlation.png" width="500">
...
Однако нельзя забывать, что между признаками могут быть нелинейные зависимости, которые на тепловой карте не отобразятся, что отразится на точности предсказания моделей.
