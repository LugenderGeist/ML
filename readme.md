...
![heatmap](.\support_files\full_correlation.png)

Далее выделены признаки, корреляция с целевой переменной у которых более 30% по модулю.

![heatmap2](.\support_files\high_correlation.png)
...
![decision_tree](.\support_files\decision_tree.png)
...
![learning](.\support_files\neural_network_learning_curves.png)

![weights](.\support_files\neural_network_weights.png)

![denses](.\support_files\denses.png)
### DVC
...
## Заключение
В результате выполнения работы были получены навыки преобработки данных, построения различных моделей для предсказания целевой переменной. Были получены навыки работы с DVC. В результате обцчения моделей получены следующие метрики:
...
Наилучший результат показал CatBoost...
