...
Однако нельзя забывать, что между признаками могут быть нелинйеные зависимости, которые на тепловой карте не отобразятся, что отразится на точности предсказания моделей.
...
После этого удалось получить точности:
...
Основные выводы по изменению метрик:
