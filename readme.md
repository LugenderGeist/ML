...
катбуст  
Увеличение глубины увеличивает время построения модели (сильно). Снижение коэф. регуляризации увеличило точность на тестовоц выборке, но и разница между обучющей и тествой выросла, что говорит о переобучении. (логично, ведь для этого и нужна регуляризация)

нейронка
количество нейронов в слоях очевидно увеличивает точность, но и время расчета (чуть-чуть). Learning rate - шаг спуска, его увеличение почему-то повышает точность. Дроп аут изначально поставила 0.2, понизила до 0.1 стало лучше.
